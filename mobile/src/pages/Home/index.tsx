...
const Home = () => {
  ...
  function handleNavigateToPoints() {
    selectedUf && selectedCity ? navigation.navigate('Points', {uf: selectedUf, city: selectedCity}) : Alert.alert('Selecione um estado e uma cidade para prosseguir');    
  }
    ...
    >
      ...
      <View style={styles.footer}>
        ...
        <RNPickerSelect
          ...
          placeholder={{ value: null, label: 'Selecione a cidade' }}
